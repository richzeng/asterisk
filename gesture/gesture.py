...
two_left = make_default_gesture("Two Left", 2, (-1, 0), (50, 0), terminal.move_left, delay=0.25)
two_right = make_default_gesture("Two Right", 2, (1, 0), (50, 0), terminal.move_right, delay=0.25)
